...
Public Class RPT01
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles Button2.Click
        ...
        rpt.paraname = New String() {"@FromDate", "@ToDate", "Header", "@ItemId", "@TypeId"}
        rpt.paravalue = New String() {FromDate.SelectedDate, ToDate.SelectedDate, CType(Parent, Page).Title, ItemId.Text, Val(TypeId.Text)}
        Select Case Flag
            Case 1
                rpt.Rpt = "ProfitRatio1.rpt"
                rpt.paravalue = New String() {FromDate.SelectedDate, ToDate.SelectedDate, TypeName.Text.Trim, ItemId.Text, Val(TypeId.Text)}
            Case 2
